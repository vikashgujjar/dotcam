    ...
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white px-6 py-12">
      <div className="max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        ...
        <div className="space-y-6 md:col-span-8">
          ...
          >
            Video & music production experts: podcasts, weddings, maternity shoots, branding & social media management. We blend creativity & precision to tell your story. Let’s elevate your vision with stunning visuals & sound!
          ...
          <div data-aos="fade-up" data-aos-delay="400">
            ...
            <div className="flex space-x-6 text-gray-300 text-base">
              <a
                href="https://www.instagram.com/dotcam_productions?igsh=emR3cnFqazRndTR0&utm_source=qr"
                className="hover:text-red-500 transition flex gap-2 items-center"
              >
                <FaInstagram /> Instagram
              </a>
              <a
                href="https://www.facebook.com/share/18QUcC8xZ1/?mibextid=wwXIfr"
                className="hover:text-red-500 transition flex gap-2 items-center"
              >
                <FaFacebook /> Facebook
              </a>
              <a
                href="https://www.tiktok.com/@dotcam_productions?_r=1&_t=ZS-933tVNqxKjN"
                className="hover:text-red-500 transition flex gap-2 items-center"
              >
                <FaTiktok /> Tiktok
              </a>
